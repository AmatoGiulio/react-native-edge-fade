...
const cards = profiles.map((profile, index) => {
  ...
  return [
    ...
    '<header><strong>' +
      ...
      '</span></header>',
    '<div class="pair">',
    '<figure><figcaption>closed · full device</figcaption><img src="./' + prefix + '-closed.png?t=' + Date.now() + '"></figure>',
    '<figure><figcaption>open · full device</figcaption><img src="./' + prefix + '-open.png?t=' + Date.now() + '"></figure>',
    '</div>',
    '</section>',
  ].join('\n');
}).join('\n');
...
const referenceSection = hasReference
  ? [
      ...
      '<div class="pair">',
      '<figure><figcaption>closed ref · full frame</figcaption><img src="./reference-closed.png?t=' + Date.now() + '"></figure>',
      '<figure><figcaption>open ref · full frame</figcaption><img src="./reference-open.png?t=' + Date.now() + '"></figure>',
      '</div>',
      '</section>',
    ].join('\n')
